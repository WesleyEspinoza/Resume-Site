...
const TowerDefenseClient = dynamic(() => import("./TowerDefenseClient"), {
  ssr: false,
});

export default function TowerDefenseWrapper() {
  ...
  if (isLoaded) {
    return <TowerDefenseClient autoStart />;
  }
