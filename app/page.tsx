      ...
      <div className="max-w-4xl mx-auto">
        ...
        <Section title="Where I’ve Made an Impact">
          <Job
            ...
            points={[
              ...
              "Mentor and train junior techs on repair workflows, diagnosing issues, and customer interaction.",
          ...
          <Job
            ...
            points={[
              ...
              "Prioritized accessibility, SEO, and load speed.",
            ]}
          />
          <Job
            ...
            points={[
              "Built scalable applications to enhance the shopping experience of millions.",
              "Worked across teams to reduce internal tooling friction and speed up deployments.",
        ...
        <Section title="Want to Support Ethical Tech Directly?">
          <p>
            ...
            organizations putting people at the center of technology. Every one of them is committed
            to digital inclusion, ethical engineering, or tech education for underrepresented groups.
          </p>
          ...
          <ul className="mt-4 list-disc pl-6 space-y-2 text-sm leading-relaxed">
            <li>
              ...
              — Expanding opportunities for Black and Latinx people in tech through career programs and advocacy.
            </li>
            <li>
              <a
              ...
              — Closing the gender gap in tech and helping young women build the skills to make a difference.
            </li>
            <li>
              <a
            ...
            <li>
              <a
                href="https://www.techbridgegirls.org/"
                target="_blank"
                rel="noopener noreferrer"
                className="text-blue-600 hover:underline"
              >
              ...
              — Empowering girls from low-income communities through STEM education and mentorship.
            </li>
            <li>
              <a
                href="https://www.publicgood.github.io/"
                target="_blank"
                rel="noopener noreferrer"
                className="text-blue-600 hover:underline"
              >
              ...
              — Building tools to connect people with real-world causes — from social justice to tech inclusion.
            </li>
            <li>
              <a
              ...
              — Bringing more girls of color into STEM careers through early education and exposure.
            </li>
            <li>
              <a
              ...
              — Advocating for tech that respects human well-being instead of exploiting attention.
            </li>
          </ul>

          <p className="mt-4 text-sm text-zinc-600 dark:text-zinc-400 leading-relaxed">
            Whether it’s through shared knowledge, dollars, or code — thanks for caring about a kinder tech future.
          </p>
        </Section>
      </div>
    </main>
